...
const Portfolio = () => {
  ...
  // Create array of unique portfolio images
  const portfolioImages = [
    { src: portfolio1, alt: "Photo 1", category: "Headshots" },
    { src: portfolio2, alt: "Photo 2", category: "Lifestyle" },
    { src: portfolio3, alt: "Photo 3", category: "Fashion" },
    { src: portfolio4, alt: "Photo 4", category: "Outdoor" },
    { src: portfolio5, alt: "Photo 5", category: "Character" },
    { src: portfolio6, alt: "Photo 6", category: "Cultural" },
    { src: portfolio7, alt: "Photo 7", category: "BTS" },
    { src: portfolio8, alt: "Photo 8", category: "Fitness" },
    { src: portfolio9, alt: "Photo 9", category: "Street" },
    { src: portfolio10, alt: "Photo 10", category: "Drama" },
    { src: portfolio11, alt: "Photo 11", category: "Drama" },
    { src: portfolio12, alt: "Photo 12", category: "Drama" },
    { src: portfolio13, alt: "Photo 13", category: "Drama" },
    { src: portfolio14, alt: "Photo 14", category: "Drama" },
    { src: portfolio15, alt: "Photo 15", category: "Drama" },
    { src: portfolio16, alt: "Photo 16", category: "Drama" },
    { src: portfolio17, alt: "Photo 17", category: "Drama" },
    { src: portfolio18, alt: "Photo 18", category: "Drama" },
    { src: portfolio19, alt: "Photo 19", category: "Drama" },
    { src: portfolio20, alt: "Photo 20", category: "Drama" },
  ];
